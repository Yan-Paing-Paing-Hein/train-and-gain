...
if ($plan_result->num_rows > 0) {
    ...
    if ($plan['status'] === 'Planned') {
        die("<h1 style='text-align:center; margin-top:50px;'>This diet plan has already been submitted and cannot be edited.</h1>");
    }
} else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If no plan yet → insert new
        ...
        $insert = $conn->prepare("
            INSERT INTO created_diet_plans
    ...
    header("Location: diet_plan.php?id=$client_id");
    exit;
}
?>
...
<body id="top">
    ...
    <section class="contact fade-up" id="contact">
        <div class="contact-container">
            <div class="section-header">
                <h2 class="section-title">Create Diet Plan for Client ID.<?php echo $client_id; ?></h2>
                ...
                <form class="contact-form" method="POST" style="max-width:800px; margin:auto;">
                    ...
                    ?>
                        <div class="form-group">
                            <label for="<?php echo $key; ?>">Diet Plan for <?php echo $label; ?>:</label>
                            <textarea
                                id="<?php echo $key; ?>"
                                name="<?php echo $key; ?>"
                                rows="5"
                                placeholder="Write your diet plan for <?php echo $label; ?>"><?php echo htmlspecialchars($plan[$key]); ?></textarea>
                        </div>
                    <?php endforeach; ?>
    ...
    <div id="draftModal" class="modal-overlay">
        <div class="modal-box">
            <h3>Diet plan saved!</h3>
            <p>Diet plan saved as draft successfully!</p>
